...
Last synced with project state: **2026-07-05** (through CHANGELOG entry `2026-07-05n` — ARCH-3 migration framework, ARCH-4 scheduler split, GO-5b 3 new DSL families, GO-5c OOS audit, GO-1 Go/No-Go UI scorecard — see Timeline phase K).
