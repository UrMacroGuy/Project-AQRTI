...
# AQRTINet was removed from the active training pipeline 2026-07-07 after
# the 50k-sample comparison (AUC-ROC 0.448 vs CatBoost 0.497) showed it
# underperformed both baselines. It will be re-enabled once development
# produces a version that beats CatBoost (see IMPROVEMENTS.md).
MODEL_CLASSES = {
...
def run_walk_forward_validation(
    ...
    Args:
        ...
        model_names: Subset of ["catboost"] to run
