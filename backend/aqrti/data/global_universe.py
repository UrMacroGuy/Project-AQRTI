...
GLOBAL_UNIVERSE: dict[str, dict] = {
    ...
    "LTIM.NS":        {"name": "LTIMindtree",                  "sector": "Technology",       "industry": "IT Services",            "exchange": "NSE", "currency": "INR", "region": "IN"},
    ...
    "TATAMOTORS.NS":  {"name": "Tata Motors",                  "sector": "Auto",             "industry": "Automobiles",            "exchange": "NSE", "currency": "INR", "region": "IN"},
    ...
    "CSGN.SW": {"name": "Credit Suisse Group AG",        "sector": "Financial Services",  "industry": "Banks",                  "exchange": "SIX",  "currency": "CHF", "region": "CH"},
